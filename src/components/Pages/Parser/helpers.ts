...
export const getParsedBill = async (file: File): Promise<ParsedBill> => {
...
export const getParsedInstructions = async (file: File) => {
    const bill = await getParsedBill(file);
